...
CONTAINS
    ...
    SUBROUTINE set_Card_Keyword()
        th_card(1:n_keyword) =   ["Th_control        ",    &
                            ...
                            !The input parameters below are used only in solid module

                            !================================================================================================
                            !                       (id) (phase type) (method to calculate lambda) (epsilon) (power density)
                            !composition_solidmodule 1    2            3                            4          5
                            !phase type: 1 for only solid;2 for only helium;3 for solid with helium flowing                            
                            &     "composition_solidmodule ",   &
                            !================================================================================================
                    
                            !================================================================================================
                            !    (num_channel) (diameter_rod)(diameter_coolant) 
                            !duct 1          2             3                       
                            &     "   channel_solidmodule  ",     &
                            !================================================================================================
                            ...
                            !================================================================================================
                            !               (z_num) (r_num) (theta_num)
                            !node_num_no_duct   1       2        3                           
                            &     " node_num_no_channel     ",    &
                            !================================================================================================ 
                            ...
                            !================================================================================================
                            !                       (r)      (theta)      (bc_z(1)) (bc-z(2)) ... (bc_z(z_num+1))      
                            !boundary_condition_z   1~r_num  1~theta_num    1         2       ...   4
                            !bc_z(i): 1 for dirichlet, 2 for neumann, 3 for robin, 4 for continuous                            
