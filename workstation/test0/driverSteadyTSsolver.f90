...
real(TS_DOUBLE),allocatable :: j_axial_l(:,:,:), j_axial_r(:,:,:),t_axial_l(:,:,:), t_axial_r(:,:,:)
real(TS_DOUBLE),allocatable :: t_radial_l(:,:,:),t_radial_r(:,:,:),t_circum_l(:,:,:),t_circum_r(:,:,:)
real(TS_DOUBLE),allocatable :: z_leakage(:,:,:),r_leakage(:,:,:),theta_leakage(:,:,:)
real(TS_DOUBLE),allocatable :: u_ch(:),b_ch(:),d_ch(:),y_ch(:),a_ch(:),c_ch(:),x_ch(:),l_ch(:)
